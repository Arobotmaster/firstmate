...
description: >-
  ...
  Contains verified facts for claude, mirasim, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, agy, and devin.
...
Mirasim, Muse, Gemini, AGY, and Devin are verified only for crewmate and scout work, never a secondmate or primary.
