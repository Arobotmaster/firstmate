...
config/claude-launcher  optional launcher wrapper for Claude worker launches: absent or "claude" uses the standard binary, "mirasim" prefixes the launch with mirasim claude; LOCAL, gitignored; crewmate/scout only; see docs/configuration.md "Claude launcher"
